...
function UpdateBook({ selectedBook, updateBook }) {
  ...
  // Pre-fill fields with selected book's current values
  useEffect(() => {
    if (selectedBook) {
  ...
  const handleSubmit = async () => {
    ...
    await updateBook(selectedBook.id, title, author)
    navigate("/")
  }
  ...
  return (
    <div style={{
      ...
      <h2 style={{ color: "#333", fontSize: "28px", marginBottom: "20px" }}>Update Book</h2>
